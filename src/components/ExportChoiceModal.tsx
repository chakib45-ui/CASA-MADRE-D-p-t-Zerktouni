      ...
      >
        ...
        <div className="p-5 space-y-3 text-xs">
          ...
          {activeFolder !== 'all' && (
            <button
              ...
              className="w-full text-left p-3.5 rounded-lg border-2 border-[#8c6239]/40 hover:border-[#8c6239] bg-[#faf7f2] hover:bg-[#f3ece0] transition-all flex items-start justify-between gap-3 group cursor-pointer"
            >
              <div>
                <div className="flex items-center gap-1.5 font-bold text-[#5c3e21] text-sm">
                  <span>📂 Dossier actif : « {effectiveFolder} »</span>
                </div>
                <p className="text-stone-600 text-[11px] mt-1">
                  Exporte uniquement les <span className="font-semibold text-[#8c6239]">{activeFolderArticlesCount} article(s)</span> de ce dossier.
                </p>
              </div>
          ...
          <button
            ...
            className="w-full text-left p-3.5 rounded-lg border border-stone-200 hover:border-[#8c6239] bg-white hover:bg-stone-50 transition-all flex items-start justify-between gap-3 group cursor-pointer"
          >
            <div>
              ...
              <p className="text-stone-500 text-[11px] mt-1">
                Exporte la totalité des <span className="font-semibold text-stone-800">{totalArticlesCount} articles</span> de tous les dossiers combinés.
              </p>
            </div>
            <span className="px-2.5 py-1 rounded bg-stone-100 group-hover:bg-[#8c6239] text-stone-700 group-hover:text-white font-semibold text-[10.5px] flex-shrink-0 mt-0.5 transition-colors">
              Exporter tout
            </span>
          </button>
        </div>
        ...
        <div className="px-5 py-3 border-t border-stone-200 bg-stone-50 flex justify-end">
          <button
            type="button"
            onClick={onClose}
            className="px-4 py-1.5 text-xs text-stone-600 hover:bg-stone-200 rounded border border-stone-300"
          >
            Annuler
          </button>
        </div>
